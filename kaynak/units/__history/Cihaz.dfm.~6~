object CihazForm: TCihazForm
  ...
  object qCihaz: TUniQuery
    ...
    SpecificOptions.Strings = (
      ...
      'InterBase.KeyGenerator=GEN_CIHAZLAR_ID')
    Left = 216
    Top = 232
    ParamData = <
      item
  ...
  object dsCihaz: TDataSource
    DataSet = qCihaz
    OnStateChange = dsCihazStateChange
    Left = 264
    Top = 232
  end
end
