object UFirmalarForm: TUFirmalarForm
  Left = 0
  Top = 0
  Width = 1012
  Height = 653
  ...
  object UniPanel1: TUniPanel
    ...
    object UniToolBar1: TUniPanel
      ...
      object btnBilgi: TUniBitBtn
        Left = 170
        Top = 2
        Width = 56
        Height = 56
        Hint = 'Kay'#305't Bilgileri'
        Margins.Left = 5
        Margins.Top = 5
        Margins.Right = 5
        Margins.Bottom = 5
      ...
      object btnGridExport: TUniBitBtn
        Left = 282
        Top = 2
        Width = 56
        Height = 56
        Hint = 'Excel Dosyas'#305' Olarak Kaydet'
        Margins.Left = 5
        Margins.Top = 5
        Margins.Right = 5
        Margins.Bottom = 5
      ...
      object btnAdres: TUniBitBtn
        ...
        Width = 56
        Height = 56
        Hint = 'Adres bilgilerini g'#246'r'#252'nt'#252'le'
        Margins.Left = 5
        Margins.Top = 5
        Margins.Right = 5
        Margins.Bottom = 5
      ...
      object btnRapor: TUniBitBtn
        Left = 338
        Top = 2
        Width = 56
        Height = 56
        Hint = 'Rapor Olu'#351'tur'
        Margins.Left = 5
        Margins.Top = 5
        Margins.Right = 5
        Margins.Bottom = 5
    ...
    object Grid: TUniDBGrid
      ...
      Columns = <
        ...
        item
          FieldName = 'MAH_AD'
          Title.Caption = 'Mahalle'
          Width = 110
        end
        item
          FieldName = 'FRM_CADDE_SOKAK'
          Title.Caption = 'Cadde/Sokak'
          Width = 130
        end
        item
          FieldName = 'FRM_BINA_ADI'
          Title.Caption = 'Bina Ad'#305
          Width = 110
        end
        item
          FieldName = 'FRM_BINA_NO'
          Title.Caption = 'Bina No'
          Width = 110
        end
        item
          FieldName = 'FRM_DAIRE_NO'
          Title.Caption = 'Daire No'
          Width = 110
        end
        item
          FieldName = 'FRM_ADRES'
        ...
        item
          FieldName = 'FRM_PK'
          Title.Caption = 'Posta Kutusu'
          Width = 110
        end
        item
          FieldName = 'FRM_WEB'
          Title.Caption = 'Web Adresi'
          Width = 250
        end
        item
          FieldName = 'FRM_ACIKLAMA'
  ...
  object qFirmalar: TUniQuery
    ...
    SQL.Strings = (
      'Select FIRMALAR.*, IL_AD, ILC_AD, MAH_AD'
      'From FIRMALAR'
      'Left Join ILLER On IL_ID=FRM_IL_ID'
      'Left Join ILCELER On ILC_ID=FRM_ILC_ID'
      'Left Join MAHALLELER On MAH_ID=FRM_MAH_ID'
      'Order By FRM_ADI')
