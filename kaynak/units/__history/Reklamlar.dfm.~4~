object ReklamlarForm: TReklamlarForm
  Left = 0
  Top = 0
  Width = 1012
  Height = 653
  ...
  object dsReklamlar: TDataSource
    DataSet = qReklamlar
    Left = 360
    Top = 328
  end
  ...
  object qReklamlar: TUniQuery
    Connection = UniServerModule.Data
    SQL.Strings = (
      'Select *'
      'From REKLAMLAR'
      'Order By R_DOSYA_ADI')
